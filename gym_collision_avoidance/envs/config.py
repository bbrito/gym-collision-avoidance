...
class Config:
    ...
    SCENARIOS_FOR_TRAINING = ["agent_with_corridor", "agent_with_door", "test_agent_with_obstacle", "train_stage_1"]#["train_agents_swap_circle","train_agents_random_positions","train_agents_pairwise_swap"]
